        ...
        <div class="modal-dialog">
            <div class="modal-content border-primary">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        <img src="{{ $post->image }}" alt="Post {{ $post->id }}" class="img-fluid" style="max-width: 200px;">
                ...
                <div class="modal-footer border-0">
                    <form action="{{ route('admin.posts.unhide', $post->id) }}" method="post">
                        ...
                        <button type="" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal">Cancel</button>
            ...
            <div class="modal-content border-danger">
                ...
                <div class="modal-footer border-0">
                    <form action="{{ route('admin.posts.hide', $post->id) }}" method="post">
                        ...
                        <button type="" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal">Cancel</button>
